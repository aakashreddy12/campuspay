        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="text-center p-4">
            ...
            <p className="text-sm text-gray-600">
              Students, vendors, advertisers, and admins
            </p>
          </div>
          ...
          <div className="text-center p-4">
            ...
            <p className="text-sm text-gray-600">
              Targeted campus advertising network
            </p>
          </div>
            ...
            <CardContent>
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-xs text-gray-600 space-y-1">
                  <div>Student: 2025112233 / password123</div>
                  <div>Vendor: vendor@example.com / password123</div>
                  <div>Advertiser: advertiser@example.com / password123</div>
